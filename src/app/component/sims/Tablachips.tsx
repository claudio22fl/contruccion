          ...
          <tbody>
            {currentData.map(({id ,numero,numerosim,puk,sim,cliente,numerodetelefono,fechainicio,vencimiento,correo,valor}: any) => (
              <tr key={id as string}
                ...
                <td className='py-2 w-20 text-xs px-4 border-b'>{formatDate(fechainicio)}</td>
                <td className='py-2 w-20 text-xs px-4 border-b'>{formatDate(vencimiento)}</td>
                ...
                <td className='py-4 text-m  px-4 border-b flex space-x-2.5'>
                  <button><svg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 24 24' stroke-width='1.5' stroke='currentColor' className='w-8 h-8 text-green-500 rounded-sm'>
                    <path stroke-linecap='round' stroke-linejoin='round' d='M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3m-3.75 3h15a2.25 2.25 0 002.25-2.25V6.75A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25v10.5A2.25 2.25 0 004.5 19.5z' />
                  </svg>
                  </button>
                  <button><svg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 24 24' stroke-width='1.5' stroke='currentColor' className='w-8 h-8 text-yellow-500'>
                    <path stroke-linecap='round' stroke-linejoin='round' d='M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10' />
                  </svg>
                  </button>
                  <button><svg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 24 24' stroke-width='1.5' stroke='currentColor' className='w-8 h-8 text-red-500'>

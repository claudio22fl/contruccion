...
import { deletesims } from "@/app/controller/delete-sims";
...
export default function Tablachips({ posts , refreshTable }: tableChipsProps) {
      ...
      <table className="min-w-full border-gray-300">
        <thead className="border-b bg-white font-medium dark:border-neutral-500 dark:bg-neutral-600">
          <tr>
            ...
            <th className="py-2 text-xs px-4 border-b">Fecha inicio</th>
          ...
          {currentData.map(
            ({
              ...
              >
                ...
                <td className="py-2 text-xs px-4 text-center border-b">
                  {numero}
                </td>
                <td className="py-2 text-xs px-4 text-center border-b">
                  {numerosim}
